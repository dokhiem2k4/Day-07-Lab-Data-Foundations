...
class EmbeddingStore:
    ...
    def delete_document(self, doc_id: str) -> bool:
        ...
        records_to_remove = [record for record in self._store if record.get("metadata", {}).get("doc_id") == doc_id]
        ...
        if self._use_chroma and self._collection is not None:
            try:
                self._collection.delete(ids=[record["id"] for record in records_to_remove])
            except Exception:
                pass
